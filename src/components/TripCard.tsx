...
}> = ({ tripData, onClick, onUpdate, onDelete, isCollapsible = false }) => {
        ...
        >
          <div className="p-6">
            {tripData.weather_forecast_for_day && (
              <div className="mb-3 bg-gradient-to-r from-blue-50 to-indigo-50 p-3 rounded-lg border border-indigo-100 flex items-center">
                {getWeatherIcon(tripData.weather_forecast_for_day)}
                <div className="ml-3 flex-1">
                  {tripData.weather_forecast_for_day.condition && (
                    <p className="text-indigo-800 font-medium">Dự báo thời tiết: {tripData.weather_forecast_for_day.condition}</p>
                  )}
                  <div className="flex items-center gap-2 mt-1">
                    {tripData.weather_forecast_for_day.max_temp_celsius !== undefined && (
                      <span className="text-red-500 text-sm">🌡️ {tripData.weather_forecast_for_day.max_temp_celsius}°C</span>
                    )}
                    ...
                    {tripData.weather_forecast_for_day.min_temp_celsius !== undefined && (
                      <span className="text-blue-500 text-sm">🌡️ {tripData.weather_forecast_for_day.min_temp_celsius}°C</span>
                    )}
                  </div>
                ...
                {editedData.weather_forecast_for_day && (
                  <div className="p-3 border border-indigo-200 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      <div>
                        <label className="block text-sm text-gray-600 mb-1">Điều kiện thời tiết</label>
                        <input
                          type="text"
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          <label className="block text-sm text-gray-600 mb-1">Nhiệt độ thấp nhất (°C)</label>
                          <input
                            type="number"
                        ...
                        <div>
                          <label className="block text-sm text-gray-600 mb-1">Nhiệt độ cao nhất (°C)</label>
                          <input
                            type="number"
                      ...
                      <div>
                        <label className="block text-sm text-gray-600 mb-1">Tác động đến hoạt động</label>
                        <input
                          type="text"
                          ...
                          onChange={(e) => {
                            setEditedData({
                              ...
                              weather_forecast_for_day: {
                                ...editedData.weather_forecast_for_day,
                                impact_on_activities: e.target.value
                              }
                            });
                          }}
                          className="w-full px-2 py-1 border rounded"
